...
public class Arista<X> {
	...
	private Vertice<X> puntoPartida;
	private Vertice<X> puntoLlegada;
	...
	/**
         ...
         */
	public Arista(String pId_arista, Vertice<X> pPartida, Vertice<X> pLlegada, double pLongitud) {
	...
	public void setId_arista(String id_arista) {
         ...
         */
	public Vertice<X> getPuntoPartida() {
		return puntoPartida;
	}
        /**
         ...
         */
	public void setPuntoPartida(Vertice<X> puntoPartida) {
         ...
         */
	public Vertice<X> getPuntoLlegada() {
		return puntoLlegada;
	}
        /**
         ...
         */
	public void setPuntoLlegada(Vertice<X> puntoLlegada) {
